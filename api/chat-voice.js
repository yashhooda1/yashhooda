...
const MODELS = {
  ...
  'claude-fable-5-1':       { provider: 'anthropic', api: 'claude-fable-5-1' },
  'gpt-6-astra':            { provider: 'openai',    api: 'gpt-6-astra' },
  'gemini-3.8-flash':       { provider: 'google',    api: 'gemini-3.8-flash' },
