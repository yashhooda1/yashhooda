...
4. ClimatePulse — 56-year (1970–2026) NOAA climate analytics pipeline across 6 global cities: Houston (IAH), Newark (EWR), Dallas (DAL), Denver (DEN), London (LHR), and Delhi (DEL). Bronze→Silver→Gold architecture with automated weekly refresh via GitHub Actions. Key findings: Houston +0.77°F/decade, winter nighttime +1.022°F/decade, Feb-Mar 80°F days +2.07/decade; Newark +0.351°F/decade; international stations (London, Delhi) use Celsius→Fahrenheit conversion. Interactive dashboard at yashhooda.ai/#climate with city toggle comparisons — Denver included for Boulderthon marathon race planning context (5,400ft altitude, ~20°F cooler summers than Houston). Tech: Python, pandas, scikit-learn, NOAA CDO API, GitHub Actions.
