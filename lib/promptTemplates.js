    ...
    build: (userQuery, context = '', domain = 'general') => {
      const EXAMPLES = {
        ...
        career: [
          ...
          { q: 'Do I need a masters degree for AI Engineering?', a: 'No. Certifications + real deployed projects beat a degree in 2026. Build in public on GitHub and ship things.' },
        ],
        travel: [
